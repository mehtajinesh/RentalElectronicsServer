...
export const daoDeleteItemFromCartForUser = (userID, productID) => cartModel.deleteOne({
    userID: userID, productID: productID
});
export const daoUpdateProductCountCartForUser = (userID, productID, newCount) => cartModel.findOneAndUpdate({
    userID: userID, productID: productID
}, {$inc: {'productCount': newCount}})
