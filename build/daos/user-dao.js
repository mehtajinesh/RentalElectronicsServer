 ...
 */
const user_model_1 = __importDefault(require("../mongoose/user-model"));
/**
...
class UserDao {
    constructor() {
        ...
        this.updateUser = (uid, user) => __awaiter(this, void 0, void 0, function* () {
            return user_model_1.default.updateOne({ _id: uid }, { $set: user });
        });
        /**
        ...
        this.deleteUser = (uid) => __awaiter(this, void 0, void 0, function* () {
            return user_model_1.default.deleteOne({ _id: uid });
        });
        /**
         ...
         * @returns Promise To be notified when user is removed from the database
         */
        this.deleteUsersByUsername = (username) => __awaiter(this, void 0, void 0, function* () { return user_model_1.default.deleteMany({ username }); });
    }
}
